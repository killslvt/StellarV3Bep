...
using StellarV3Bep.Modules.Movement;
    ...
    internal class PlayersGUI
    {
        ...
        private static void PlayerMenu(VRC.Player player)
        {
            ...
            new GUIToggleButton("Portal Spam", () =>
            {
                ...
                if (PortalExploits.PortalCoroutine != null)
                    CoroutineHelper.Stop(PortalExploits.PortalCoroutine);

                PortalExploits.portalDrop = true;
                PortalExploits.PortalCoroutine = CoroutineHelper.Start(PortalExploits.PortalDrop(selectedPlayer));
        ...
        private static void SitOnPlayerMenu()
        {
            ...
            new GUISingleButton("Sit On Head", () =>
            {
                ...
                {
                    CoroutineHelper.Start(SitOnPlayer.AttachTo(SitOnPlayer.BodyPart.Head, selectedPlayer));
                }
                else
                {
            ...
            new GUISingleButton("Sit On Right Shoulder", () =>
            {
                ...
                if (SitOnPlayer.isSitting)
                {
                    CoroutineHelper.Start(SitOnPlayer.AttachTo(SitOnPlayer.BodyPart.Right_Shoulder, selectedPlayer));
                }
                else
                {
                    SitOnPlayer.isSitting = false;
            ...
            new GUISingleButton("Sit On Left Shoulder", () =>
            {
                ...
                if (SitOnPlayer.isSitting)
                {
                    CoroutineHelper.Start(SitOnPlayer.AttachTo(SitOnPlayer.BodyPart.Left_Shoulder, selectedPlayer));
                }
                else
                {
                    SitOnPlayer.isSitting = false;
            ...
            new GUISingleButton("Sit On Right Hand", () =>
            {
                ...
                if (SitOnPlayer.isSitting)
                {
                    CoroutineHelper.Start(SitOnPlayer.AttachTo(SitOnPlayer.BodyPart.Right_Hand, selectedPlayer));
                }
                else
                {
                    SitOnPlayer.isSitting = false;
            ...
            new GUISingleButton("Sit On Left Hand", () =>
            {
                ...
                if (SitOnPlayer.isSitting)
                {
                    CoroutineHelper.Start(SitOnPlayer.AttachTo(SitOnPlayer.BodyPart.Left_Hand, selectedPlayer));
                }
                else
                {
                    SitOnPlayer.isSitting = false;
