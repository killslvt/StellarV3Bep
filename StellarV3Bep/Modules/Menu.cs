...
{
    internal class Menu : BaseModule
    {
        #region QuickMenuStuff
        public void Start()
        {
            CoroutineHelper.Start(WaitForQM());
        }
        ...
        public static void InfoGUI()
        {
            ...
            GUI.Label(new Rect(10, 10, 300, 30), $"<b>Stellar V3 BepinEx</b>", textStyle);
        ...
        public static void MainGUI()
        {
            ...
            windowRect = GUI.Window(0, windowRect, (GUI.WindowFunction)DrawWindow, "<color=#FFFFFF>Stellar V3 BepinEx</color>  <color=#FFFFFF>https://discord.gg/myuWgYP8WS</color>");
        }
        ...
        private static void DrawWindow(int id)
        {
            ...
            switch (selectedTab)
            {
                case 0: Menus.MovementGUI.Menu(); break;
                case 1: Menus.VisualGUI.Menu(); break;
                case 2: Menus.WorldHacksGUI.Menu(); break;
                case 3: Menus.PlayersGUI.Menu(); break;
                case 4: Menus.ExploitGUI.Menu(); break;
            }
